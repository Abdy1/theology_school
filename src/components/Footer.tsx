          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 bg-primary-foreground/10 rounded-lg px-3 py-2 hover:bg-primary-foreground/20 transition-all duration-300 hover:scale-105 text-sm"
                title="YouTube"
              >
